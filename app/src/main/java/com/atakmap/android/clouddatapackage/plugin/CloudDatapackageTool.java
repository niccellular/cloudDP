...
import com.atakmap.android.clouddatapackage.CloudDatapackageDropDownReceiver;
...
public class CloudDatapackageTool extends Tool implements ToolDescriptor {

    private final Context context;

    public CloudDatapackageTool(Context context) {
    ...
    public void onActivate(Activity arg0, MapView arg1, ViewGroup arg2,
        ...
        Intent i = new Intent(
                CloudDatapackageDropDownReceiver.SHOW_PLUGIN);
